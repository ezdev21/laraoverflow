...
<div>
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10">
            <h1 class="text-3xl py-2">Edit the question here</h1><hr>
            <form wire:submit.prevent="update" class="my-2">
                <div>
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <input wire:model.lazy="question.title" id="title" value="{{$question->title}}" name="title" type="text" required autofocus placeholder="title" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-primary focus:border-primary transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('email') border-red-300 text-red-900 placeholder-red-300 focus:border-red-300 focus:ring-red @enderror" />
                    </div>
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <textarea wire:model.lazy="question.description" id="description" value="{{$question->description}}" required placeholder="description" rows="5"
